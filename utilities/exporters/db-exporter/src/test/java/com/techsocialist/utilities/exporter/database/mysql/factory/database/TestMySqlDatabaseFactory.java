...
public class TestMySqlDatabaseFactory extends TestCase {
    ...
    public void testMySqlDatabase() {
        ...
        assertEquals("com.techsocialist.utilities.exporter.database.mysql.MySqlDatabase",databaseInst.getClass().getName());
    }
    ...
    public void testMySqlDatabaseAsMSSql2005Database() {
        ...
        Database databaseInst = MySqlDatabaseFactory.getInstance(database);
        assertTrue(databaseInst != null);
        assertEquals("com.techsocialist.utilities.exporter.database.mysql.MySqlDatabaseAsMSSql2005Database",databaseInst.getClass().getName());
    }
    ...
    public void testMySqlDatabaseAsMSSql2008Database() {
        ...
        Database databaseInst = MySqlDatabaseFactory.getInstance(database);
        assertTrue(databaseInst != null);
        assertEquals("com.techsocialist.utilities.exporter.database.mysql.MySqlDatabaseAsMSSql2008Database",databaseInst.getClass().getName());
    }
    ...
    public void testMySqlDatabaseAsOracleDatabase() {
        ...
        Database databaseInst = MySqlDatabaseFactory.getInstance(database);
        assertTrue(databaseInst != null);
        assertEquals("com.techsocialist.utilities.exporter.database.mysql.MySqlDatabaseAsOracleDatabase",databaseInst.getClass().getName());
    }
    ...
    public void testMySqlDatabaseAsSQLiteDatabase() {
        ...
        Database databaseInst = MySqlDatabaseFactory.getInstance(database);
        assertTrue(databaseInst != null);
        assertEquals("com.techsocialist.utilities.exporter.database.mysql.MySqlDatabaseAsSQLiteDatabase",databaseInst.getClass().getName());
    }
    ...
    public void testMySqlDatabaseAsPostgreSqlDatabase() {
        ...
        Database databaseInst = MySqlDatabaseFactory.getInstance(database);
        assertTrue(databaseInst != null);
        assertEquals("com.techsocialist.utilities.exporter.database.mysql.MySqlDatabaseAsPostgreSqlDatabase",databaseInst.getClass().getName());
    }
    ...
    public void testMySqlDatabaseAsIngresDatabase() {
        ...
        Database databaseInst = MySqlDatabaseFactory.getInstance(database);
        assertTrue(databaseInst != null);
        assertEquals("com.techsocialist.utilities.exporter.database.mysql.MySqlDatabaseAsIngresDatabase",databaseInst.getClass().getName());
    }
