...
public class MySqlDatabaseAsMSSql2005Database extends MySqlDatabase {

	public MySqlDatabaseAsMSSql2005Database() {
	...
	public String exportAsSql(boolean withData) throws SQLException {
		...
		buffer.append(getDatabaseCreateStatement()).append("\n");
	...
	public String getTableCreateStatement(String table) throws SQLException {
		...
		DataTypeMapper mapper = MySqlDataTypeMapperFactory.getInstance(Database.MYSQL_AS_MSSQL_2005);
