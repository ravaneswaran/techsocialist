...
public class MySqlDatabaseAsIngresDatabase extends MySqlDatabase{

    public MySqlDatabaseAsIngresDatabase() {
    ...
    public String getTableCreateStatement(String table) throws SQLException {
        ...
        DataTypeMapper mapper = MySqlDataTypeMapperFactory.getInstance(Database.MYSQL_AS_INGRES);
        Statement statement = this.connection.createStatement();
        ResultSet resultSet = statement.executeQuery("DESC " + table);
        if (null != resultSet) {
            buffer.append("CREATE TABLE ").append(this.dbName).append(".").append(table).append("(")
                    .append("\n");
