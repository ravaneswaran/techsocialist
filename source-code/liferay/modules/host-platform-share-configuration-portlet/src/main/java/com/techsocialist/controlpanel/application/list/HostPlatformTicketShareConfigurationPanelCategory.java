...
public class HostPlatformTicketShareConfigurationPanelCategory extends BasePanelCategory {

	@Override
	public String getKey() {
		return HostPlatformTicketShareConfigurationPanelCategoryKeys.CONTROL_PANEL_CATEGORY;
	}
