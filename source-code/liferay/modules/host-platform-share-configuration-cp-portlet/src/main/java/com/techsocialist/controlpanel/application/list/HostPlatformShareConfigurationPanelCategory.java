...
public class HostPlatformShareConfigurationPanelCategory extends BasePanelCategory {

	@Override
	public String getKey() {
		return HostPlatformShareConfigurationPanelCategoryKeys.CONTROL_PANEL_CATEGORY;
	}
