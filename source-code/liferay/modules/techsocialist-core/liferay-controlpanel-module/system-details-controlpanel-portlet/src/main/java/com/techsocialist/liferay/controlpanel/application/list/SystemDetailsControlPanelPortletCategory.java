...
public class SystemDetailsControlPanelPortletCategory extends BasePanelCategory {

	@Override
	public String getKey() {
		return SystemDetailsControlPanelPortletCategoryKeys.CONTROL_PANEL_CATEGORY;
	}
