...
/**
 * Provides the local service interface for ProductionHouseRegister. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProductionHouseRegisterLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProductionHouseRegisterLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProductionHouseRegisterLocalServiceUtil} to access the production house register local service. Add custom service methods to <code>com.techsocialis.servicebuilder.service.impl.ProductionHouseRegisterLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
