...
/**
 * The persistence utility for the ticket service. This utility wraps <code>com.techsocialist.servicebuilder.service.persistence.impl.TicketPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class TicketUtil {
	...
	private static ServiceTracker<TicketPersistence, TicketPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(TicketPersistence.class);

		ServiceTracker<TicketPersistence, TicketPersistence> serviceTracker =
			new ServiceTracker<TicketPersistence, TicketPersistence>(
				bundle.getBundleContext(), TicketPersistence.class, null);
