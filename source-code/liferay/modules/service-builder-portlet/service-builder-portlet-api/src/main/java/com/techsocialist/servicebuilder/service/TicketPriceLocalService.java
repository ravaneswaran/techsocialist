...
/**
 * Provides the local service interface for TicketPrice. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TicketPriceLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TicketPriceLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TicketPriceLocalServiceUtil} to access the ticket price local service. Add custom service methods to <code>com.techsocialist.servicebuilder.service.impl.TicketPriceLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
