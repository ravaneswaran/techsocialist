...
/**
 * Provides the local service utility for TicketTax. This utility wraps
 * <code>com.techsocialist.servicebuilder.service.impl.TicketTaxLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TicketTaxLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.techsocialist.servicebuilder.service.impl.TicketTaxLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.techsocialist.servicebuilder.model.TicketTax addTicketTax(
		com.techsocialist.servicebuilder.model.TicketTax ticketTax) {

		return getService().addTicketTax(ticketTax);
	}
	 ...
	 */
	public static com.techsocialist.servicebuilder.model.TicketTax
		createTicketTax(long id) {

		return getService().createTicketTax(id);
	}
	 ...
	 */
	public static com.techsocialist.servicebuilder.model.TicketTax
			deleteTicketTax(long id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().deleteTicketTax(id);
	}
	...
	public static com.techsocialist.servicebuilder.model.TicketTax
		...
		return getService().deleteTicketTax(ticketTax);
	}
	...
	public static com.techsocialist.servicebuilder.model.TicketTax
		fetchTicketTax(long id) {

		return getService().fetchTicketTax(id);
	}
	 ...
	 * @throws PortalException if a ticket tax with the primary key could not be found
	 */
	public static com.techsocialist.servicebuilder.model.TicketTax getTicketTax(
			long id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getTicketTax(id);
	}
	...
	public static java.util.List
		<com.techsocialist.servicebuilder.model.TicketTax> getTicketTaxs(
			int start, int end) {

		return getService().getTicketTaxs(start, end);
	}
	 ...
	 */
	public static int getTicketTaxsCount() {
		return getService().getTicketTaxsCount();
	}
	...
	public static com.techsocialist.servicebuilder.model.TicketTax
		...
		return getService().updateTicketTax(ticketTax);
	}

	public static TicketTaxLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<TicketTaxLocalService, TicketTaxLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(TicketTaxLocalService.class);

		ServiceTracker<TicketTaxLocalService, TicketTaxLocalService>
			serviceTracker =
				new ServiceTracker
					<TicketTaxLocalService, TicketTaxLocalService>(
						bundle.getBundleContext(), TicketTaxLocalService.class,
						null);
