...
public interface ProductionHouseRegisterEntryLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProductionHouseRegisterEntryLocalServiceUtil} to access the production house register entry local service. Add custom service methods to <code>com.techsocialist.servicebuilder.service.impl.ProductionHouseRegisterEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
