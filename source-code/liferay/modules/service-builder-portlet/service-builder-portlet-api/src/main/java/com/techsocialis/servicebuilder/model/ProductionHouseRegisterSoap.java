 ...
 * @generated
 */
public class ProductionHouseRegisterSoap implements Serializable {

	public static ProductionHouseRegisterSoap toSoapModel(
		ProductionHouseRegister model) {

		ProductionHouseRegisterSoap soapModel =
			new ProductionHouseRegisterSoap();
	...
	public static ProductionHouseRegisterSoap[] toSoapModels(
		ProductionHouseRegister[] models) {

		ProductionHouseRegisterSoap[] soapModels =
			new ProductionHouseRegisterSoap[models.length];
	...
	public static ProductionHouseRegisterSoap[][] toSoapModels(
		...
		ProductionHouseRegisterSoap[][] soapModels = null;
		...
		if (models.length > 0) {
			...
			soapModels = new ProductionHouseRegisterSoap[0][0];
		}
	...
	public static ProductionHouseRegisterSoap[] toSoapModels(
		List<ProductionHouseRegister> models) {

		List<ProductionHouseRegisterSoap> soapModels =
			new ArrayList<ProductionHouseRegisterSoap>(models.size());

		for (ProductionHouseRegister model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(
			new ProductionHouseRegisterSoap[soapModels.size()]);
	}

	public ProductionHouseRegisterSoap() {
	}
