...
/**
 * <p>
 * This class is a wrapper for {@link VideoRegisterEntry}.
 * </p>
 *
 ...
 * @generated
 */
public class VideoRegisterEntryWrapper
	extends BaseModelWrapper<VideoRegisterEntry>
	implements ModelWrapper<VideoRegisterEntry>, VideoRegisterEntry {

	public VideoRegisterEntryWrapper(VideoRegisterEntry videoRegisterEntry) {
		super(videoRegisterEntry);
	}
	...
	@Override
	protected VideoRegisterEntryWrapper wrap(
		VideoRegisterEntry videoRegisterEntry) {

		return new VideoRegisterEntryWrapper(videoRegisterEntry);
	}
