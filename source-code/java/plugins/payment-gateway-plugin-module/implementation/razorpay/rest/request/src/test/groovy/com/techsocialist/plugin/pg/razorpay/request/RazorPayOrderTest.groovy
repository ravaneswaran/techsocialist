...
class RazorPayOrderTest extends Specification {
    ...
    def "test RazorPayOrder as json"(){
        ...
        razorPayOrder.setId("12345").setEntity(IRazorPayEntity.ORDER_ENTITY).setCreatedAt(createdAt)
        razorPayOrder.setCurrency("INR").setAmount(10000).setAmountPaid(0).setAmountDue(10000)
        razorPayOrder.setAttempts(0).setReceipt("receipt_001").setStatus("created")
