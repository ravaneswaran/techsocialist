...
public class MandateFormNotifyRequest extends AbstractPaytmRequest {
    ...
    protected String getStagingUrlEndPointPrefix() {
        return "https://securegw-stage.paytm.in/subscription/paper/mandate/notifyUpload";
    }

    @Override
    protected String getProductionUrlEndPointPrefix() {
        return "https://securegw.paytm.in/subscription/paper/mandate/notifyUpload";
    }
    ...
    public MandateFormNotifyRequest setTokenType(String tokenType) {
        this.tokenType = tokenType;
        return this;
    }

    public MandateFormNotifyRequest setSubscriptionId(String subscriptionId) {
